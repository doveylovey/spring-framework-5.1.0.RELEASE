...
public interface TransactionDefinition {
    ...
    /**
     * Return the propagation behavior. 返回事务的传播行为：默认值为 REQUIRED
     * <p>
    ...
    /**
     * Return the isolation level. 返回事务的隔离级别：默认值为 DEFAULT
     * <p>
    ...
    /**
     * Return the transaction timeout. 返回事务的超时时间：默认值为 -1。如果超过该时间限制但事务还没有完成，则自动回滚事务
     * <p>
    ...
    /**
     * Return whether to optimize as a read-only transaction. 返回是否为只读事务：默认值为 false
     * <p>
