...
public class InitializeDatabaseIntegrationTests {
    ...
    public void testCreateEmbeddedDatabase() throws Exception {
        ...
        System.out.println("=====>the scripts will be executed? " + System.getProperty("ENABLED"));
    ...
    public void testCacheInitialization() throws Exception {
        ...
        List<Map<String, Object>> cachedData = cache.getCachedData();
        cachedData.forEach(System.out::println);
    }

    private void assertCorrectSetup(DataSource dataSource) {
        JdbcTemplate jdbcTemplate = new JdbcTemplate(dataSource);
        int count = jdbcTemplate.queryForObject("select count(*) from T_TEST", Integer.class).intValue();
        System.out.println("=====>" + count);
        assertEquals(1, count);
        String s = jdbcTemplate.queryForObject("select NAME from T_TEST", String.class);
