...
import com.study.tx.annotation.dao.AnnotationOrderItemDao;
 ...
 */
@Service
public class AnnotationOrderItemServiceImpl implements AnnotationOrderItemService {
    @Resource
    private AnnotationOrderItemDao annotationOrderItemDao;
